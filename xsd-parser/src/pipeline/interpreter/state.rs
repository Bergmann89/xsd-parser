...
pub(super) struct State<'a> {
    ...
    /// List of types to be interpreted as dynamic type.
    dynamic_types: HashSet<TypeIdent>,
...
impl<'a> State<'a> {
    ...
    pub(super) fn add_dynamic_type<I>(&mut self, ident: I)
    where
        I: Into<TypeIdent>,
    {
        let ident = ident.into();
        self.dynamic_types.insert(ident);
    }

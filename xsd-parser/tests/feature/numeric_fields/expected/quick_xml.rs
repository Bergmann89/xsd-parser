...
pub mod quick_xml_deserialize {
    ...
    impl FooTypeDeserializer {
        ...
        fn finish_state(
            ...
            match state {
                S::_4(Some(deserializer)) => self.store_4(deserializer.finish(helper)?)?,
                _ => (),
            }
            Ok(())
        }
        ...
        fn handle_4<'de>(
            ...
            match artifact {
                ...
                DeserializerArtifact::Deserializer(deserializer) => {
                    fallback.get_or_insert(FooTypeDeserializerState::_4(Some(deserializer)));
                    *self.state__ = FooTypeDeserializerState::Done__;
                    Ok(ElementHandlerOutput::from_event(event, allow_any))
                }
            }
            ...
            let (event, allow_any) = loop {
                ...
                event = match (state, event) {
                    ...
                    (S::_4(Some(deserializer)), event) => {
                        ...
                        match self.handle_4(helper, output, &mut fallback)? {
        ...
        fn next_event(
            ...
            loop {
                match &mut *self.state {
                    ...
                    FooTypeSerializerState::_4(x) => match x.next(helper).transpose()? {

...
pub mod tns {
    ...
    pub mod schema_2 {
        ...
        pub mod quick_xml_serialize {
            ...
            #[derive(Debug)]
            pub(super) enum PersonTypeSerializerState<'ser> {
                Init__ , Name (< :: std :: string :: String as :: xsd_parser_types :: quick_xml :: WithSerializer > :: Serializer < 'ser >) , Gender (< super :: super :: base :: GenderType as :: xsd_parser_types :: quick_xml :: WithSerializer > :: Serializer < 'ser >) , LastName (< :: std :: string :: String as :: xsd_parser_types :: quick_xml :: WithSerializer > :: Serializer < 'ser >) , Age (< :: core :: primitive :: i32 as :: xsd_parser_types :: quick_xml :: WithSerializer > :: Serializer < 'ser >) , End__ , Done__ , Phantom__ (& 'ser ()) , }
            impl<'ser> PersonTypeSerializer<'ser> {
                fn next_event(
                    &mut self,
                    helper: &mut ::xsd_parser_types::quick_xml::SerializeHelper,

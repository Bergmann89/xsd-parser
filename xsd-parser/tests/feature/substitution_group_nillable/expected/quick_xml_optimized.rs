...
pub mod quick_xml_deserialize {
    ...
    pub enum AnimalDeserializerState {
        ...
        Dog(
            Option<super::DogDyn>,
            Option<<super::DogDyn as WithDeserializer>::Deserializer>,
            Option<<super::DogDyn as WithDeserializer>::Deserializer>,
        ),
        Labrador(
            Option<super::LabradorDyn>,
            Option<<super::LabradorDyn as WithDeserializer>::Deserializer>,
            Option<<super::LabradorDyn as WithDeserializer>::Deserializer>,
        ),
        Done__(super::Animal),
        Unknown__,
    ...
    impl AnimalDeserializer {
        fn find_suitable<'de>(
            ...
            if let Event::Start(x) | Event::Empty(x) = &event {
                ...
                if matches!(
                    ...
                    let output = <super::DogDyn as WithDeserializer>::init(helper, event)?;
                ...
                if matches!(
                    ...
                    let output = <super::LabradorDyn as WithDeserializer>::init(helper, event)?;
        ...
        fn store_dog(
            values: &mut Option<super::DogDyn>,
            value: super::DogDyn,
        ) -> Result<(), Error> {
            if values.is_some() {
        ...
        fn store_labrador(
            values: &mut Option<super::LabradorDyn>,
            value: super::LabradorDyn,
        ) -> Result<(), Error> {
            if values.is_some() {
                Err(ErrorKind::DuplicateElement(RawByteStr::from_slice(
                    b"labrador",
        ...
        fn handle_dog<'de>(
            &mut self,
            helper: &mut DeserializeHelper,
            mut values: Option<super::DogDyn>,
            fallback: Option<<super::DogDyn as WithDeserializer>::Deserializer>,
            output: DeserializerOutput<'de, super::DogDyn>,
        ) -> Result<ElementHandlerOutput<'de>, Error> {
            use AnimalDeserializerState as S;
            let DeserializerOutput {
                artifact,
        ...
        fn handle_labrador<'de>(
            &mut self,
            helper: &mut DeserializeHelper,
            mut values: Option<super::LabradorDyn>,
            fallback: Option<<super::LabradorDyn as WithDeserializer>::Deserializer>,
            output: DeserializerOutput<'de, super::LabradorDyn>,
        ) -> Result<ElementHandlerOutput<'de>, Error> {
            use AnimalDeserializerState as S;
            let DeserializerOutput {
                artifact,
...
pub mod quick_xml_serialize {
    ...
    pub(super) enum AnimalSerializerState<'ser> {
        ...
        Dog(<super::DogDyn as WithSerializer>::Serializer<'ser>),
        Labrador(<super::LabradorDyn as WithSerializer>::Serializer<'ser>),
        Done__,
        Phantom__(&'ser ()),
    }

...
impl WithSerializer for Animal {
    ...
    fn serializer<'ser>(
        ...
        if (*self.0).as_any().is::<AnimalDyn>() {
            return self.0.serializer(Some("animal"), is_root);
        }
        if (*self.0).as_any().is::<DogDyn>() {
            return self.0.serializer(Some("dog"), is_root);
        }
        if (*self.0).as_any().is::<LabradorDyn>() {
...
pub mod quick_xml_deserialize {
    ...
    pub enum AnimalDeserializer {
        ...
        Dog(<super::DogDyn as WithDeserializer>::Deserializer),
        Labrador(<super::LabradorDyn as WithDeserializer>::Deserializer),
    }
        ...
        fn init(
            ...
            if matches!(
                ...
                let DeserializerOutput {
                    ...
                    event,
                    allow_any,
                } = <super::DogDyn as WithDeserializer>::init(helper, event)?;
                return Ok(DeserializerOutput {
            ...
            if matches!(
                ...
                let DeserializerOutput {
                    ...
                    event,
                    allow_any,
                } = <super::LabradorDyn as WithDeserializer>::init(helper, event)?;
                return Ok(DeserializerOutput {

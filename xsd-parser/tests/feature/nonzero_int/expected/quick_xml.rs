...
pub mod quick_xml_deserialize {
    ...
    impl FooTypeDeserializer {
        fn from_bytes_start(
            ...
            let mut a_int: Option<NonZeroUsize> = None;
            let mut b_int: Option<NonZeroIsize> = None;
            ...
            Ok(Self {
                a_int: a_int.ok_or_else(|| ErrorKind::MissingAttribute("a-int".into()))?,
                b_int: b_int.ok_or_else(|| ErrorKind::MissingAttribute("b-int".into()))?,

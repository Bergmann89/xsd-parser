...
fn generate_default() {
    generate_test(
        ...
        "tests/feature/facets_binary/expected/default.rs",
        config(),
    );
}
...
fn generate_quick_xml() {
    generate_test(
        "tests/feature/facets_binary/schema.xsd",
        "tests/feature/facets_binary/expected/quick_xml.rs",
...
fn generate_serde_xml_rs() {
    generate_test(
        "tests/feature/facets_binary/schema.xsd",
        "tests/feature/facets_binary/expected/serde_xml_rs.rs",
...
fn generate_serde_quick_xml() {
    generate_test(
        "tests/feature/facets_binary/schema.xsd",
        "tests/feature/facets_binary/expected/serde_quick_xml.rs",

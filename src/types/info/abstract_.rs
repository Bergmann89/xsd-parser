//! Contains the [`AbstractInfo`] type information and all related types.

use crate::types::{Ident, TypeEq, Types};

/// Type information that contains data about abstract types.
#[derive(Default, Debug, Clone)]
pub struct AbstractInfo {
    /// Base type of the abstract type.

...
fn generate_default() {
    generate_test(
        "tests/feature/ref_to_attribute/schema.xsd",
        "tests/feature/ref_to_attribute/expected/default.rs",
...
fn generate_quick_xml() {
    generate_test(
        "tests/feature/ref_to_attribute/schema.xsd",
        "tests/feature/ref_to_attribute/expected/quick_xml.rs",
        Config::test_default()
            .with_quick_xml()
...
fn generate_serde_xml_rs() {
    generate_test(
        "tests/feature/ref_to_attribute/schema.xsd",
        "tests/feature/ref_to_attribute/expected/serde_xml_rs.rs",
        Config::test_default()
...
fn generate_serde_quick_xml() {
    generate_test(
        "tests/feature/ref_to_attribute/schema.xsd",
        "tests/feature/ref_to_attribute/expected/serde_quick_xml.rs",
        Config::test_default()

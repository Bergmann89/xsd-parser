...
fn generate_default() {
    generate_test(
        ...
        "tests/feature/tuple_with_integer/expected/default.rs",
        Config::test_default()
...
fn generate_quick_xml() {
    generate_test(
        "tests/feature/tuple_with_integer/schema.xsd",
        "tests/feature/tuple_with_integer/expected/quick_xml.rs",
        Config::test_default()
            .with_quick_xml()
            .with_typedef_mode(TypedefMode::NewType)
            .with_generate([(IdentType::Element, "tns:Foo")]),
...
fn read_quick_xml() {
    ...
    let obj = crate::utils::quick_xml_read_test::<Foo, _>(
        "tests/feature/tuple_with_integer/example/default.xml",
    );

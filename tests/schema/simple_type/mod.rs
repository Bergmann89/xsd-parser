...
fn generate_default() {
    generate_test(
        "tests/schema/simple_type/schema.xsd",
        "tests/schema/simple_type/expected/default.rs",
...
fn generate_quick_xml() {
    generate_test(
        "tests/schema/simple_type/schema.xsd",
        "tests/schema/simple_type/expected/quick_xml.rs",
        Config::default()
            .with_quick_xml()
...
fn generate_serde_xml_rs() {
    generate_test(
        "tests/schema/simple_type/schema.xsd",
        "tests/schema/simple_type/expected/serde_xml_rs.rs",
        Config::default()
...
fn generate_serde_quick_xml() {
    generate_test(
        "tests/schema/simple_type/schema.xsd",
        "tests/schema/simple_type/expected/serde_quick_xml.rs",
        Config::default()
...
fn read_quick_xml() {
    ...
    let obj =
        crate::utils::quick_xml_read_test::<Foo, _>("tests/schema/simple_type/example/default.xml");
...
fn read_serde_xml_rs() {
    ...
    let obj = crate::utils::serde_xml_rs_read_test::<Foo, _>(
        "tests/schema/simple_type/example/default.xml",
    );

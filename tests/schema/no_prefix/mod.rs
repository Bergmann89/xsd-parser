...
fn generate_default() {
    generate_test(
        "tests/schema/no_prefix/schema.xsd",
        "tests/schema/no_prefix/expected/default.rs",
        Config::test_default()
...
fn generate_quick_xml() {
    generate_test(
        "tests/schema/no_prefix/schema.xsd",
        "tests/schema/no_prefix/expected/quick_xml.rs",
...
fn generate_serde_xml_rs() {
    generate_test(
        "tests/schema/no_prefix/schema.xsd",
        "tests/schema/no_prefix/expected/serde_xml_rs.rs",
        Config::test_default()
...
fn generate_serde_quick_xml() {
    generate_test(
        "tests/schema/no_prefix/schema.xsd",
        "tests/schema/no_prefix/expected/serde_quick_xml.rs",
        Config::test_default()
...
fn read_quick_xml() {
    ...
    let obj =
        crate::utils::quick_xml_read_test::<Foo, _>("tests/schema/no_prefix/example/default.xml");
...
fn write_quick_xml() {
    ...
    crate::utils::quick_xml_write_test(&obj, "Foo", "tests/schema/no_prefix/example/serialize.xml");
}
...
fn read_serde_xml_rs() {
    ...
    let obj =
        crate::utils::serde_xml_rs_read_test::<Foo, _>("tests/schema/no_prefix/example/serde.xml");
...
fn read_serde_quick_xml() {
    ...
    let obj = crate::utils::serde_quick_xml_read_test::<Foo, _>(
        "tests/schema/no_prefix/example/serde.xml",
    );

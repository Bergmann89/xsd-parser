...
fn generate_default() {
    generate_test(
        "tests/schema/all/schema.xsd",
        "tests/schema/all/expected/default.rs",
...
fn generate_quick_xml() {
    generate_test(
        "tests/schema/all/schema.xsd",
        "tests/schema/all/expected/quick_xml.rs",
        Config::test_default()
            .with_quick_xml()
...
fn generate_serde_xml_rs() {
    generate_test(
        "tests/schema/all/schema.xsd",
        "tests/schema/all/expected/serde_xml_rs.rs",
        Config::test_default()
...
fn generate_serde_quick_xml() {
    generate_test(
        "tests/schema/all/schema.xsd",
        "tests/schema/all/expected/serde_quick_xml.rs",
        Config::test_default()
...
fn read_quick_xml() {
    ...
    let obj = crate::utils::quick_xml_read_test::<Foo, _>("tests/schema/all/example/default.xml");
...
fn write_quick_xml() {
    ...
    crate::utils::quick_xml_write_test(&obj, "tns:Foo", "tests/schema/all/example/serialize.xml");
}
...
fn read_serde_xml_rs() {
    ...
    let obj = crate::utils::serde_xml_rs_read_test::<Foo, _>("tests/schema/all/example/serde.xml");
...
fn read_serde_quick_xml() {
    ...
    let obj =
        crate::utils::serde_quick_xml_read_test::<Foo, _>("tests/schema/all/example/serde.xml");

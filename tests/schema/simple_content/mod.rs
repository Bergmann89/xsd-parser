...
fn generate_default() {
    generate_test(
        "tests/schema/simple_content/schema.xsd",
        "tests/schema/simple_content/expected/default.rs",
...
fn generate_quick_xml() {
    generate_test(
        "tests/schema/simple_content/schema.xsd",
        "tests/schema/simple_content/expected/quick_xml.rs",
        Config::test_default()
            .with_quick_xml()
...
fn generate_serde_xml_rs() {
    generate_test(
        "tests/schema/simple_content/schema.xsd",
        "tests/schema/simple_content/expected/serde_xml_rs.rs",
        Config::test_default()
...
fn generate_serde_quick_xml() {
    generate_test(
        "tests/schema/simple_content/schema.xsd",
        "tests/schema/simple_content/expected/serde_quick_xml.rs",
        Config::test_default()
...
fn read_quick_xml() {
    ...
    let obj = crate::utils::quick_xml_read_test::<Foo, _>(
        "tests/schema/simple_content/example/default.xml",
    );

...
fn generate_default() {
    generate_test(
        "tests/schema/enumeration/schema.xsd",
        "tests/schema/enumeration/expected/default.rs",
...
fn generate_quick_xml() {
    generate_test(
        "tests/schema/enumeration/schema.xsd",
        "tests/schema/enumeration/expected/quick_xml.rs",
        Config::test_default()
            .with_quick_xml()
...
fn generate_serde_xml_rs() {
    generate_test(
        "tests/schema/enumeration/schema.xsd",
        "tests/schema/enumeration/expected/serde_xml_rs.rs",
        Config::test_default()
...
fn generate_serde_quick_xml() {
    generate_test(
        "tests/schema/enumeration/schema.xsd",
        "tests/schema/enumeration/expected/serde_quick_xml.rs",
        Config::test_default()
...
fn read_quick_xml() {
    ...
    let obj =
        crate::utils::quick_xml_read_test::<Foo, _>("tests/schema/enumeration/example/default.xml");
...
fn write_quick_xml() {
    ...
    crate::utils::quick_xml_write_test(
        &obj,
        "tns:Foo",
        "tests/schema/enumeration/example/default.xml",
    );
}

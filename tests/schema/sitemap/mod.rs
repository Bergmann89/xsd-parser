...
macro_rules! assert_obj {
    ($obj:expr, $changefreq:ident) => {{
        ...
        assert!(matches!(url.changefreq, Some($changefreq::Monthly)));
        ...
        assert!(matches!(url.changefreq, Some($changefreq::Weekly)));
        ...
        assert!(matches!(url.changefreq, None));
...
fn read_serde_xml_rs() {
    use serde_xml_rs::{TChangeFreqType, Urlset};
